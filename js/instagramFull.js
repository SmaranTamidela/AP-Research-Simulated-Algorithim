...
function logEngagementToSheets(videoObj, metrics) {
  const formURL = "https://docs.google.com/forms/d/e/1FAIpQLScIe6b9bw7u8vam_CYSHsWnIXO2H_j6suKQDuT7o5wjcj95Pw/formResponse";
  const formData = new FormData();

  formData.append("entry.800062558", videoObj.src);
  formData.append("entry.617682250", videoObj.category);
  formData.append("entry.603577842", videoObj.username);
  formData.append("entry.1672226586", metrics.liked ? "TRUE" : "FALSE");
  formData.append("entry.1854335123", metrics.favorited ? "TRUE" : "FALSE");
  formData.append("entry.1455919305", metrics.watchedPercent);
