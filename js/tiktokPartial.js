...
function logEngagementToSheets(videoObj, metrics, feedType) {
  const formURL = "https://docs.google.com/forms/d/e/1FAIpQLSep9V79mQOkMJcaTtFfMqctqqKQmfjkajuLUdtIlbhxHjGY2A/formResponse";
  const formData = new FormData();

  formData.append("entry.2042513432", videoObj.src);
  formData.append("entry.1069451717", videoObj.category);
  formData.append("entry.1558797441", videoObj.username);
